...
@js.native
@nowarn
private[this] trait ReadableStream[+T] extends js.Object {
  ...
  /** See
    ...
    * //todo: determine the type of options
    */
  def pipeTo(dest: WriteableStream[T], options: Any = js.native): Unit =
    js.native
...
private[this] object ReadableStream {
...
/** See [[https://streams.spec.whatwg.org/#underlying-source-api ¶4.2.3. The underlying source API]] of whatwg streams
  ...
  */
private[this] trait ReadableStreamUnderlyingSource[T] extends js.Object {
  ...
  var start: js.UndefOr[
    js.Function1[ReadableStreamController[T], js.UndefOr[js.Promise[Unit]]]
  ] =
    js.undefined
...
/** See [[https://streams.spec.whatwg.org/#qs-api ¶7.1. The queuing strategy API]]
  ...
  *   Type of the Chunks returned by the Stream
  */
private[this] trait QueuingStrategy[T] extends js.Object {
...
@js.native
private[this] sealed trait ReadableStreamType extends js.Any

private[this] object ReadableStreamType {
...
@JSGlobal
@nowarn
private[this] class ReadableStreamController[-T] private[this] ()
    extends js.Object {
